...
<style>
    ...
    .adopt_pet_main_new .slideee .MultiCarousel .leftLst.over, .MultiCarousel .rightLst.over{
        background-color: #A6341B;
    }
    ...
    .MultiCarousel .MultiCarousel-inner { transition: 1s ease all; float: left; }
        ...
        .MultiCarousel .MultiCarousel-inner .item > div { text-align: center; border: 1px solid #A6341B; margin:8px; }
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="cardimage">
                    ...
                    <?php for($i=1; $i<5; $i++){$img="image$i";  if(@$list->$img != NULL){  ?>
                    <div class="cardimage">
