        ...
        <div class="container">
            ...
            <div class="flex">
                ...
                <div class="card">
                    ...
                    <a href="<?php echo base_url() . "problems/" . $value['link'] ?>"><img src="<?php echo $value['image']; ?>" alt=""> </a>
                    <h3><?php echo $value['head']; ?></h3>
                    <p><?php echo $result; ?>.... <a href="<?php echo base_url() . "problems/" . $value['link'] ?>">Read More </a> </p>
                    </div>
            ...
            <div class="flex">
                ...
                <div class="card">
                    ...
                    <div class="inner_card">
                    <a href="<?php echo base_url() . "problems/" . $value['link'] ?>"><video src="<?php echo $value['image']; ?>" alt="" ></video> </a>
                    <h3><?php echo $value['head']; ?></h3>
                    <p><?php echo $result; ?>.... <a href="<?php echo base_url() . "problems/" . $value['link'] ?>">Read More </a> </p>
                    </div>
