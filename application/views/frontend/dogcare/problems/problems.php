        ...
        <div class="row">
            <div class="col">
                <p><a href="<?php echo base_url() ?>" class="nodecoration bc_link">Home</a> /
                    <a href="<?php echo base_url() ?>problems" class=" nodecoration bc_link bc_link_active">Problems</a>
                </p>
            </div>
        </div>
    </div>
                            ...
                            <?php foreach ($blogs as $value) { ?>
                                <div class="col-md-4 py-2">
                                    <div class="pet_blog_box tranning_card">
                                        <a href="<?php echo base_url() . "problems/" . $value['link'] ?>">
                                            <div class="py-2">
