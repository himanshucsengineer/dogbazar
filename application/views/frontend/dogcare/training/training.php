...
<div class="news_main train_bg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <p><a href="<?php echo base_url() ?>"><span class="acc">Home</a></span> / <a href="<?php echo base_url() ?>training">Dog Care / Training</a></p>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        function load_data(limit, start) {
            $.ajax({
                url: "<?php echo base_url(); ?>frontend/dogcare/training/training/fetch",
                method: "POST",
                data: {
                    limit: limit,
                    start: start
...
<script>
    $(document).ready(function() {
        ...
        function load_data(limit, start) {
            $.ajax({
                url: "<?php echo base_url(); ?>frontend/dogcare/training/training/fetch_video",
                method: "POST",
                data: {
                    limit: limit,
                    start: start
