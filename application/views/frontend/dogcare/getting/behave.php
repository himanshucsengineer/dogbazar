        ...
        <div class="row">
            <div class="col">
                <p><a href="<?php echo base_url() ?>" class="nodecoration bc_link">Home</a> /
                    <a href="<?php echo base_url() ?>getting" class=" nodecoration bc_link bc_link_active">Getting A Dog</a>
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="tranning_page_head">
                            <h2 class="h2_head">Getting A Dog</h2>
                        </div>
                    </div>
                </div>
                            ...
                            <?php foreach ($blogs as $value) { ?>
                                <div class="col-md-4 py-2">
                                    <div class="pet_blog_box tranning_card">
                                        <a href="<?php echo base_url() . "getting/" . $value['link'] ?>">
                                            <div class="py-2">
