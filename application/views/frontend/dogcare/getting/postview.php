...
<div class="breadcrumb">
    <div class="container">
        <div class="row">
            <div class="col">
                <p><a href="<?php echo base_url() ?>" class="nodecoration bc_link">Home</a> / <a href="<?php echo base_url() ?>getting" class="nodecoration bc_link">Getting A Dog</a> /
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-md-4 px-5">
                    ...
                    <?php foreach ($releted as $rel) : ?>
                        ...
                        <a href="<?php echo base_url() . "getting/" . @$rel->link ?>" class="nodecoration">
                            <div class="row mb-3">
                    ...
                    <?php foreach ($recents as $recent) : ?>
                        <a href="<?php echo base_url() . "getting/" . @$recent->link ?>" class="nodecoration">
                            <div class="row mb-3">
                                <div class="col-4 py-3">
