        ...
        <div class="row">
            <div class="col">
                <p><a href="<?php echo base_url() ?>" class="nodecoration bc_link">Home</a> /
                    <a href="<?php echo base_url() ?>petcare" class=" nodecoration bc_link bc_link_active">Pet Care Videos</a>
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="tranning_page_head">
                            <h2 class="h2_head">Pet Care Videos</h2>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-md-4 py-2">
                                    <div class="pet_blog_box tranning_card">
                                        <a href="<?php echo base_url() . "petcare/" . $value['link'] ?>">
                                            <div class="py-2">
                                                <video class="video" src="<?php echo $value['image']; ?>"></video>
                                            </div>
                                            <div class="px-3">
