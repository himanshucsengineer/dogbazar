        ...
        <div class="container">
            ...
            <div class="flex">
                ...
                <div class="card">
                    ...
                    <a href="<?php echo base_url() . "petcare/" . $value['link'] ?>"><video src="<?php echo $value['image']; ?>" alt="" ></video> </a>
                    <h3><?php echo $value['head']; ?></h3>
                    <p><?php echo $result; ?>.... <a href="<?php echo base_url() . "petcare/" . $value['link'] ?>">Read More </a> </p>
                    </div>
