...
if ($exttt[1] == "mp4") {
    $videotagmain = '<video src="'.base_url().'upload/dogcare/givingup/' . @$blog->image . '" controls ></video>';
} else {
    $videotagmain = '<img src="'.base_url().'upload/dogcare/givingup/' . @$blog->image . '" >';
} ?>
...
<div class="news_main givingup_bg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <p><a href="<?php echo base_url() ?>"><span class="acc">Home</a></span> / <a href="<?php echo base_url() ?>givingup">Dog Care / Giving uo Your Dog</a> / <?php echo @$blog->head ?></p>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <?php foreach ($recents as $recent) { ?>
                        ...
                        $ext = explode('.', $last);
                        if ($ext[1] == "mp4") {
                            $videotagrecent = '<video src="'.base_url().'upload/dogcare/givingup/' . @$recent->image . '"  ></video>';
                        } else {
                            $videotagrecent = '<img src="'.base_url().'upload/dogcare/givingup/' . @$recent->image . '" >';
                        } ?>
                ...
                <div class="box">
                    ...
                    <?php foreach ($releted as $rel) { ?>
                        ...
                        $extt = explode('.', $lastt);
                        if ($extt[1] == "mp4") {
                            $videotagrelated = '<video src="'.base_url().'upload/dogcare/givingup/' . @$rel->image . '"  ></video>';
                        } else {
                            $videotagrelated = '<img src="'.base_url().'upload/dogcare/givingup/' . @$rel->image . '" >';
                        } ?>
