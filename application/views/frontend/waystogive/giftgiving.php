        ...
        <div class="row">
            <div class="col">
                <p><a href="<?php echo base_url() ?>" class="nodecoration bc_link">Home</a> /
                    <a href="<?php echo base_url() ?>gift-giving" class=" nodecoration bc_link bc_link_active">Gift Giving</a>
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="tranning_page_head">
                            <h1 class="h2_head col_fff">Gift Giving</h1>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col">
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control base_input donar_input_pay" name="amount" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Your Amount">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            <!-- <label for="" class="donate_input_lable pb-3">Mobile Number</label> -->
                                            <input type="text" class="form-control base_input" name="gift" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Gift Name">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
