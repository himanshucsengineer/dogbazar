...
<div class="all_post">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h3>All Pet Memorials</h3>
      </div>
      <div class="col-md-6">
        <a href="<?php echo base_url(); ?>admin/petmemorial"><button class="ad">+</button></a>
      </div>
    </div>
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <?php echo form_open(base_url('admin/petmemorialdata'), array('method' => 'post')); ?>
