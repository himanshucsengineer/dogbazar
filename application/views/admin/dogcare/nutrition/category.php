...
<div class="blog-category">
    <div class="container">
      ...
      ?>
        ...
        <form action="<?php echo base_url();?>admin/dogcare/nutrition/category/insert" method="post" id="referform">
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <?php echo form_open(base_url('admin/dogcare/nutrition/category/deletecardetail'), array('method'=>'post'));?>
  ...
  $(document).ready(function() {
    $('#lowinventory').DataTable( {
        "ajax": "<?php echo base_url(); ?>admin/dogcare/nutrition/category/addinventory_api"
    } );
