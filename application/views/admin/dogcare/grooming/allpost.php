...
<div class="all_post">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h3>Dog Grooming News All Post</h3>
      </div>
      <div class="col-md-6">
            ...
            <tbody>
              <?php foreach($allpost as $value){ if($value['cate'] == "news") {?>
                <tr>
                  ...
                  <td><img  src="<?php echo base_url()?>upload/dogcare/grooming/<?php echo $value['image'] ?>"></td>
...
<div class="all_post">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h3>Dog Grooming Video All Post</h3>
      </div>
      <div class="col-md-6">
            ...
            <tbody>
              <?php foreach($allpost as $value){ if($value['cate']=="video"){?>
                <tr>
                  <td><?php echo $value['id'] ?></td>
                  <td><?php echo $value['head'] ?></td>
                  <td><video src="<?php echo base_url()?>upload/dogcare/grooming/<?php echo $value['image'] ?>" controls></video></td>
                  <td><?php echo $value['cate']?></td>
                  <td><?php echo $value['subcategory']?></td>
                  <td><?php echo $value['date']?></td>
                  <td><a href="<?php echo base_url()?>admin/dogcare/grooming/editpost?id=<?php echo $value['id'] ?>"    >Edit</a></td>
