            ...
            <tbody>
              <?php foreach($allpost as $value){ if($value['cate'] == "news") {?>
                <tr>
                  ...
                  <td><img  src="<?php echo base_url()?>upload/dogcare/problems/<?php echo $value['image'] ?>"></td>
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <?php echo form_open(base_url('admin/dogcare/problems/allpost/deletepost'), array('method' => 'post')); ?>
