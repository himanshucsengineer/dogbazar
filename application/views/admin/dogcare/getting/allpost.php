...
<div class="all_post">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h3>Getting a dog News All Post</h3>
      </div>
      <div class="col-md-6">
        <a href="<?php echo base_url(); ?>admin/dogcare/getting/newpost"><button class="ad">+</button></a>
      </div>
    </div>
            ...
            <tbody>
              <?php foreach($allpost as $value){ if($value['cate'] == "news") {?>
                <tr>
                  ...
                  <td><a href="<?php echo base_url()?>admin/dogcare/getting/editpost?id=<?php echo $value['id'] ?>"    >Edit</a></td>
...
<div class="all_post">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h3>Getting A Dog Video All Post</h3>
      </div>
      <div class="col-md-6">
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <?php echo form_open(base_url('admin/dogcare/getting/allpost/deletepost'), array('method' => 'post')); ?>
