...
<div class="blog-category">
    <div class="container">
        ...
        <form action="<?php echo base_url(); ?>admin/dogcare/givingup/category/insert" method="post" id="referform">
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <?php echo form_open(base_url('admin/dogcare/givingup/category/deletecardetail'), array('method' => 'post')); ?>
...
<script>
    $(document).ready(function() {
        $('#lowinventory').DataTable({
            "ajax": "<?php echo base_url(); ?>admin/dogcare/givingup/category/addinventory_api"
        });
