...
<div class="all_post">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h3>Giving Up Your Dog News All Post</h3>
      </div>
      <div class="col-md-6">
        <a href="<?php echo base_url(); ?>admin/dogcare/givingup/newpost"><button class="ad">+</button></a>
      </div>
    </div>
            ...
            <tbody>
              <?php foreach($allpost as $value){ if($value['cate'] == "news") {?>
                <tr>
                  ...
                  <td><img  src="<?php echo base_url()?>upload/dogcare/givingup/<?php echo $value['image'] ?>"></td>
                  <td><?php echo $value['cate']?></td>
                  <td><?php echo $value['subcategory']?></td>
                  <td><?php echo $value['date']?></td>
                  <td><a href="<?php echo base_url()?>admin/dogcare/givingup/editpost?id=<?php echo $value['id'] ?>"    >Edit</a></td>
...
<div class="all_post">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h3>Giving up your dog Video All Post</h3>
      </div>
      <div class="col-md-6">
            ...
            <tbody>
              <?php foreach($allpost as $value){ if($value['cate']=="video"){?>
                <tr>
                  <td><?php echo $value['id'] ?></td>
                  <td><?php echo $value['head'] ?></td>
                  <td><video src="<?php echo base_url()?>upload/dogcare/givingup/<?php echo $value['image'] ?>" controls></video></td>
                  <td><?php echo $value['cate']?></td>
                  <td><?php echo $value['subcategory']?></td>
                  <td><?php echo $value['date']?></td>
                  <td><a href="<?php echo base_url()?>admin/dogcare/givingup/editpost?id=<?php echo $value['id'] ?>"    >Edit</a></td>
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <?php echo form_open(base_url('admin/dogcare/givingup/allpost/deletepost'), array('method' => 'post')); ?>
