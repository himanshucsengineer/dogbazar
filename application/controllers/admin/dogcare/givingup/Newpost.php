...
class Newpost extends CI_controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('admin/dogcare/givingup/Catemodel');
        $this->load->model('admin/dogcare/givingup/Newpostmodel');
    }
    ...
    public function index()
    {
        ...
        $this->load->view('admin/dogcare/givingup/newpost', $data);
    ...
    public function post()
    {
        ...
        if (!empty($_FILES['images']['name'])) {
            $File_name = '';
            $config['upload_path'] = APPPATH . '../upload/dogcare/givingup';
            ...
            if (!$this->upload->do_upload('images')) {
                ...
                redirect('admin/dogcare/givingup/newpost');
            } else {
                $dataimage_return = $this->upload->data();
                $imageurl = base_url() . 'upload/dogcare/givingup/' . $dataimage_return['file_name'];
            }
        }
        ...
        if ($this->newpostmodel->newpost($datas)) {
            ...
            redirect(base_url() . 'admin/dogcare/givingup/newpost');
        } else {
