        ...
        public function index(){
          ...
          $data['fetch_category'] = $this->Catemodel->fetch_data();
           $data['fetch_content'] = $this->Allpostmodel->fetch_data();
            ...
            $this->load->view('admin/dogcare/training/editblog', $data);
            ...
            if ($this->form_validation->run()){ 
                ...
                if (!empty($_FILES['images']['name'])){
                    ...
                    if(!$this->upload->do_upload('images')) {
                        ...
                        $imageurl=base_url().'upload/dogcare/training/'.$dataimage_return['file_name'];
              ...
              foreach($data as $value){
               ...
               $head = $this->input->post('heading');
                    ...
                    redirect(base_url().'admin/dogcare/training/allpos');   
                }
