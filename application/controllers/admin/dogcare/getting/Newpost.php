...
class Newpost extends CI_controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('admin/dogcare/getting/Catemodel');
        $this->load->model('admin/dogcare/getting/Newpostmodel');
    }
    ...
    public function index()
    {
        ...
        $this->load->view('admin/dogcare/getting/newpost', $data);
    ...
    public function post()
    {
        ...
        if (!empty($_FILES['images']['name'])) {
            $File_name = '';
            $config['upload_path'] = APPPATH . '../upload/dogcare/getting';
            ...
            if (!$this->upload->do_upload('images')) {
                ...
                redirect('admin/dogcare/getting/newpost');
            } else {
                $dataimage_return = $this->upload->data();
                $imageurl = base_url() . 'upload/dogcare/getting/' . $dataimage_return['file_name'];
            }
        }
        ...
        if ($this->newpostmodel->newpost($datas)) {
            ...
            redirect(base_url() . 'admin/dogcare/getting/newpost');
        } else {
