<?php
    class Allpost extends CI_controller{
        ...
        public function index(){
            ...
            $this->load->view('admin/dogcare/getting/allpost');
       ...
       public function addinventory_api(){
            ...
            foreach ($getPurchaseData as $key => $value) { 
                ...
                $arrya_json[] = array($value['id'],$value['head'],'<img src="'.$value['image'].'">',$value['cate'],$value['date'],'<a href="'.base_url().'admin/dogcare/getting/editpost?id='.$value['id'].'"    >Edit</a>',
