...
class Allpost extends CI_controller
{
  ...
  public function index()
  {
   ...
   $data['allpost'] = $this->Allpostmodel->fetch_data();
    ...
    $this->load->view('admin/dogcare/problems/allpost', $data);
  ...
  public function addinventory_api()
  {
    ...
    foreach ($getPurchaseData as $key => $value) {
      ...
      $arrya_json[] = array(
        $value['id'], $value['head'], '<iframe  src="' . $value['image'] . '">', $value['cate'],$value['subcategory'] ,$value['date'], '<a href="' . base_url() . 'admin/dogcare/problems/editpost?id=' . $value['id'] . '"    >Edit</a>',
