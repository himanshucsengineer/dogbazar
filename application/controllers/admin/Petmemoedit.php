<?php
class Petmemoedit extends CI_controller
{
    ...
    public function index()
    {
      ...
      //  $data['fetch_content'] = $this->Allpostmodel->fetch_data();
        ...
        $this->load->view('admin/petmemoedit');
        ...
        if ($this->form_validation->run()) {
            ...
            if (!empty($_FILES['images']['name'])) {
                ...
                if (!$this->upload->do_upload('images')) {
                    ...
                    $imageurl = base_url() . 'upload/dogcare/grooming/' . $dataimage_return['file_name'];
                }
            } else {
            ...
            redirect(base_url() . 'admin/dogcare/grooming/allpos');
        }
    }
}
