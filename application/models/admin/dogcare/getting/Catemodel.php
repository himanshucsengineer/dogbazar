...
class Catemodel extends CI_Model
{
  ...
  {
    return  $this->db->insert('getting_cate', $data);
  }
  public function fetch_data()
  {
    return $this->db->get('getting_cate')->result_array();
  }
  ...
  public function deletecate($data)
  {
    ...
    $getDeleteStatus = $this->db->delete('getting_cate');
