    ...
    function get_details($id)
{
   ...
   function update_pro($head,$content,$tag,$id,$link,$imageurl,$mtitle,$mdesc,$mkey){
        ...
        $this->db->set($data);
        $this->db->where('id',$id);
         $this->db->update('training_newpost');
    }
    ...
    return $this->db->where('link',$slug)->get('training_newpost')->row();
  ...
  public function deleteposts($data)
    {
        ...
        $getDeleteStatus = $this->db->delete('training_newpost');
