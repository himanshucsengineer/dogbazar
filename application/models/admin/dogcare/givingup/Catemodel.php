...
class Catemodel extends CI_Model
{
  ...
  {
    return  $this->db->insert('givingup_cate', $data);
  }
  public function fetch_data()
  {
    return $this->db->get('givingup_cate')->result_array();
  }
  ...
  public function deletecate($data)
  {
    ...
    $getDeleteStatus = $this->db->delete('givingup_cate');
